...
def init_arg_parser():
    ...
    arg_parser.add_argument(
        "--lr_scheduler", action="store_true", help="use learning rate scheduler"
    )
    arg_parser.add_argument(
    ...
    arg_parser.add_argument(
        "--column_pointer", action="store_true", help="use column pointer"
    )
    arg_parser.add_argument(
        "--loss_epoch_threshold", default=20, type=int, help="loss epoch threshold"
    )
    arg_parser.add_argument(
        "--sketch_loss_coefficient",
        default=0.2,
        type=float,
        help="sketch loss coefficient",
    )
    arg_parser.add_argument(
        "--sentence_features", action="store_true", help="use sentence features"
    )
    arg_parser.add_argument(
        "--model_name",
        choices=["transformer", "rnn", "table", "sketch"],
        default="rnn",
        help="model name",
    )
    ...
    arg_parser.add_argument(
        "--glove_embed_path", default="glove.42B.300d.txt", type=str
    )
    ...
    arg_parser.add_argument(
        "--embed_size", default=300, type=int, help="size of word embeddings"
    )
    arg_parser.add_argument(
        "--col_embed_size", default=300, type=int, help="size of word embeddings"
    )

    arg_parser.add_argument(
        "--action_embed_size", default=128, type=int, help="size of word embeddings"
    )
    arg_parser.add_argument(
        "--type_embed_size", default=128, type=int, help="size of word embeddings"
    )
    arg_parser.add_argument(
        "--hidden_size", default=100, type=int, help="size of LSTM hidden states"
    )
    arg_parser.add_argument(
        "--att_vec_size", default=100, type=int, help="size of attentional vector"
    )
    arg_parser.add_argument("--dropout", default=0.3, type=float, help="dropout rate")
    arg_parser.add_argument(
        "--word_dropout", default=0.2, type=float, help="word dropout rate"
    )

    # readout layer
    arg_parser.add_argument(
        "--no_query_vec_to_action_map", default=False, action="store_true"
    )
    arg_parser.add_argument(
        "--readout", default="identity", choices=["identity", "non_linear"]
    )
    arg_parser.add_argument(
        "--query_vec_to_action_diff_map", default=False, action="store_true"
    )
    arg_parser.add_argument(
        "--column_att", choices=["dot_prod", "affine"], default="affine"
    )
    arg_parser.add_argument(
    ...
    arg_parser.add_argument(
        "--clip_grad", default=5.0, type=float, help="clip gradients"
    )
    arg_parser.add_argument(
